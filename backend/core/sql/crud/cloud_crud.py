...
class CRUDCloud:
    def create(self, **kwargs):
        ...
        """
        try:
            logging.info("CRUDCloud create request")
            cloud = Cloud(**kwargs)
            ...
            logging.error(f"Error in CRUDCloud create function : {error}")
            raise error
    ...
    def read(self, cloud_id: int):
        ...
        """
        try:
            logging.info("CRUDCloud read request")
            with session() as transaction_session:
                obj: Cloud = (
            ...
            logging.error(f"Error in CRUDCloud read function : {error}")
            raise error
    ...
    def read_all(self):
        ...
        """
        try:
            logging.info("CRUDCloud read all request")
            with session() as transaction_session:
            ...
            logging.error(f"Error in CRUDCloud read all function : {error}")
            raise error
    ...
    def update(self, **kwargs):
        ...
        """
        try:
            logging.info("CRUDCloud update function")
            with session() as transaction_session:
                cloud_obj: Cloud = (
                    transaction_session.query(Cloud)
            ...
            logging.error(f"Error in CRUDCloud update function : {error}")
            raise error
    ...
    def delete(self, cloud_id: int):
        ...
        """
        try:
            logging.info("CRUDCloud delete request")
            with session() as transaction_session:
                obj: Cloud = (
                    transaction_session.query(Cloud)
                    .filter(Cloud.cloud_id == cloud_id)
                ...
                transaction_session.commit()
                logging.info(f"object is : {obj.__dict__}")
                return obj.__dict__
        except Exception as error:
            logging.error(f"Error in CRUDUCloud delete function : {error}")
            raise error
