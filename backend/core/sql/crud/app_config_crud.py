...
class CRUDAppConfig:
    def create(self, **kwargs):
        ...
        """
        try:
            logging.info("CRUDAppConfig create request")
            kwargs.update(
                {
            ...
            logging.error(f"Error in CRUDAppConfig create function : {error}")
            raise error
    ...
    def read(self, config_parameter: str):
        ...
        """
        try:
            logging.info("CRUDAppConfig read request")
            with session() as transaction_session:
                obj: AppConfig = (
            ...
            logging.error(f"Error in CRUDAppConfig read function : {error}")
            raise error
    ...
    def read_all(self):
        ...
        """
        try:
            logging.info("CRUDAppConfig read all request")
            with session() as transaction_session:
            ...
            logging.error(f"Error in CRUDAppConfig read all function : {error}")
            raise error
    ...
    def update(self, config_request):
        ...
        """
        try:
            logging.info("CRUDAppConfig update function")
            with session() as transaction_session:
                obj: AppConfig = (
                    transaction_session.query(AppConfig)
                    .filter(
            ...
            logging.error(f"Error in CRUDAppConfig update function : {error}")
            raise error
    ...
    def delete(self, config_parameter: str):
        ...
        """
        try:
            logging.info("CRUDAppConfig delete request")
            with session() as transaction_session:
                obj: AppConfig = (
                    transaction_session.query(AppConfig)
                    .filter(AppConfig.config_parameter == config_parameter)
            ...
            logging.error(f"Error in CRUDUAppConfig delete function : {error}")
            raise error
