...
class AppConfigController:
    ...
    def create_app_config_controller(self, request):
        ...
        """
        try:
            logging.info("executing create_app_config_controller function")
            ...
            logging.error(f"Error in create_app_config_controller function: {error}")
            raise error
    ...
    def update_app_config_controller(self, request):
        ...
        """
        try:
            logging.info("executing update_app_config_controller function")
            ...
            logging.error(f"Error in update_app_config_controller function: {error}")
            raise error
    ...
    def get_all_app_config_controller(self):
        ...
        """
        try:
            logging.info("executing get_all_app_config_controller function")
            return self.CRUDAppConfig.read_all()
        except Exception as error:
            logging.error(f"Error in get_all_app_config_controller function: {error}")
            raise error
    ...
    def get_app_config_controller(self, config_parameter: str):
        ...
        """
        try:
            logging.info("executing get_app_config_controller function")
            return self.CRUDAppConfig.read(config_parameter=config_parameter)
        except Exception as error:
            logging.error(f"Error in get_app_config_controller function: {error}")
            raise error
    ...
    def delete_app_config_controller(self, config_parameter: str):
        ...
        """
        try:
            logging.info("executing delete_app_config_controller function")
            return self.CRUDAppConfig.delete(config_parameter=config_parameter)
        except Exception as error:
            logging.error(f"Error in delete_app_config_controller function: {error}")
