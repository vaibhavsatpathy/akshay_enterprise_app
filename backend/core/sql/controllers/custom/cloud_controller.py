...
class CloudController:
    ...
    def create_cloud_controller(self, request):
        ...
        """
        try:
            logging.info("executing create_cloud_controller function")
            ...
            logging.error(f"Error in create_cloud_controller function: {error}")
            raise error
    ...
    def update_cloud_controller(self, request):
        ...
        """
        try:
            logging.info("executing update_cloud_controller function")
            ...
            logging.error(f"Error in update_cloud_controller function: {error}")
            raise error
    ...
    def get_all_cloud_controller(self):
        ...
        """
        try:
            logging.info("executing get_all_cloud_controller function")
            return self.CRUDCloud.read_all()
        except Exception as error:
            logging.error(f"Error in get_all_cloud_controller function: {error}")
            raise error
    ...
    def get_cloud_controller(self, cloud_id: int):
        ...
        """
        try:
            logging.info("executing get_cloud_controller function")
            return self.CRUDCloud.read(cloud_id=cloud_id)
        except Exception as error:
            logging.error(f"Error in get_cloud_controller function: {error}")
            raise error
    ...
    def delete_cloud_controller(self, cloud_id: int):
        ...
        """
        try:
            logging.info("executing delete_cloud_controller function")
            return self.CRUDCloud.delete(cloud_id=cloud_id)
        except Exception as error:
            logging.error(f"Error in delete_cloud_controller function: {error}")
